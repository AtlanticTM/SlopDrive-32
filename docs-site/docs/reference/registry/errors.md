...
## `0x01xx` — session and authorisation
...
| Code | Name | Meaning |
|---|---|---|
| `0x0500` | `CHUNK_UNAVAILABLE` | blob chunk index out of range, or the requested namespace/store/slot does not exist (generalized from 'catalog chunk' by RFC-021 — the catalog is now namespace 0) |
